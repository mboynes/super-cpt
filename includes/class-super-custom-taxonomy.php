		...
		$this->args = array_merge(
			apply_filters( 'scpt_plugin_default_tax_options', array(
				...
				'labels' => array(
					...
					'separate_items_with_commas' => sprintf( __( 'Separate %s with commas' ), strtolower( $this->plural ) ),
					'add_or_remove_items'        => sprintf( __( 'Add or remove %s' ), strtolower( $this->plural ) ),
					'choose_from_most_used'      => sprintf( __( 'Choose from the most used %s' ), strtolower( $this->plural ) ),
