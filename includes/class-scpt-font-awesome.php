...
class SCPT_Font_Awesome {
	...
	public function get_font_awesome_icon( $icon ) {
		...
		switch ( $icon ) {
			...
			case 'photo': return '\f03e';
			case 'image': return '\f03e';
			...
			case 'sort-desc': return '\f0dd';
			case 'sort-up': return '\f0de';
			case 'sort-asc': return '\f0de';
			...
			case 'institution': return '\f19c';
			case 'bank': return '\f19c';
			case 'university': return '\f19c';
			case 'mortar-board': return '\f19d';
			...
			case 'automobile': return '\f1b9';
			case 'car': return '\f1b9';
			case 'cab': return '\f1ba';
			...
			case 'file-photo-o': return '\f1c5';
			case 'file-picture-o': return '\f1c5';
			case 'file-image-o': return '\f1c5';
			case 'file-zip-o': return '\f1c6';
			case 'file-archive-o': return '\f1c6';
			case 'file-sound-o': return '\f1c7';
			case 'file-audio-o': return '\f1c7';
			case 'file-movie-o': return '\f1c8';
			...
			case 'life-bouy': return '\f1cd';
			case 'life-buoy': return '\f1cd';
			case 'life-saver': return '\f1cd';
			case 'support': return '\f1cd';
			...
			case 'y-combinator-square': return '\f1d4';
			case 'yc-square': return '\f1d4';
			case 'hacker-news': return '\f1d4';
			case 'tencent-weibo': return '\f1d5';
			case 'qq': return '\f1d6';
			case 'wechat': return '\f1d7';
			case 'weixin': return '\f1d7';
			case 'send': return '\f1d8';
			case 'paper-plane': return '\f1d8';
			case 'send-o': return '\f1d9';
			...
			case 'soccer-ball-o': return '\f1e3';
			...
			case 'cc': return '\f20a';
			case 'shekel': return '\f20b';
			case 'sheqel': return '\f20b';
			...
			case 'battery-4': return '\f240';
			case 'battery-full': return '\f240';
			case 'battery-3': return '\f241';
			case 'battery-three-quarters': return '\f241';
			case 'battery-2': return '\f242';
			case 'battery-half': return '\f242';
			case 'battery-1': return '\f243';
			case 'battery-quarter': return '\f243';
			case 'battery-0': return '\f244';
